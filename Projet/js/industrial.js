...
class Industrial extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.tilemapTiledJSON('industrial', 'assets/industrial.json');
        this.load.spritesheet('industrial', 'assets/industrial.png', {frameWidth: 70, frameHeight: 70});
    ...
    create() {
        ...
        //map
        map = this.make.tilemap({key: 'industrial'});

        var groundTiles = map.addTilesetImage('industrial');
        ...
        coinLayer.setTileIndexCallback(113, collectCoin, this);
